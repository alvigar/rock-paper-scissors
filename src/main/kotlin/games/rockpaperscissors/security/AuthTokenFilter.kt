...
class AuthTokenFilter(private val userService: UserDetailsService, private val jwtUtils: JwtUtils) : OncePerRequestFilter() {
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                if (!userDetails.isEnabled) {
                    throw Exception("$username is not enabled")
                }
